...
public class DashboardController {
    ...
    public ResponseEntity<ResDashboardOverviewDTO> getOverview(
        ...
        if (periodId == null) {
            return ResponseEntity.ok(new ResDashboardOverviewDTO(0L, 0L, 0L, java.math.BigDecimal.ZERO, java.math.BigDecimal.ZERO, 0.0, 0.0, null, null, null, 0L, java.math.BigDecimal.ZERO, 0L, java.math.BigDecimal.ZERO));
        }
